        ...
        <div class="twelve wide column pull-left main main-column">
                ...
                <div class="extra-padding" style="padding-bottom:4px">
                    ...
                    <p class="book-article-meta" style="margin-bottom: 10px;">
                        ...
                        <a class="ui popover" href="javascript:">
                            <img class="ui image display-inline-block mr-1" style="width:16px;height:16px;margin-top:-3px" src="{{ $details->category->logo ? '/uploads/' . $details->category->logo : asset('blog/picture/laravel.png') }}">
                            {{ $details->category->name ? $details->category->name : '其他' }}
                        </a>
                        @endif
            ...
            <div class="ui message basic pt-2">
                <div class="ui comments pt-2" style="max-width: inherit;">
                    <div class="comment">
                        <a class="avatar" style="margin-left: 0" target="_blank" href="{{ url('blog', [$statistics['userinfo']->username, $statistics['userinfo']->id]) }}">
                            <img class="" src="{{ $statistics['userinfo']->avatar ? $statistics['userinfo']->avatar : asset('blog/picture/laravel.png') }}">
                        </a>
                        <div class="content author-user pt-2" style="margin-left: 66px;border: none;box-shadow: none">
                            <a class="author" target="_blank" href="{{ url('blog', [$statistics['userinfo']->username, $statistics['userinfo']->id]) }}">
                                {{ $statistics['userinfo']->username }}
                            </a>
                            <div class="metadata">
                                <a class="ml-1 rm-link-color mr-1" target="_blank" href="">
                                    <i class="icon trophy"></i>{{ $statistics['userinfo']->statistic->blognums }} 篇博客
                                </a>
                            </div>
                            <div class="text mt-2 rm-link-color">
                                {{ $statistics['userinfo']->introduction ? $statistics['userinfo']->introduction : '暂无个人描述~' }}&nbsp;
                    ...
                    <div class="ui small horizontal list" style="font-size:16px;padding-top: 8px;display: flex;">
                        <div class="item" style="font-size: 15px;margin-right: 12px;font-size: 15px;margin-right: 12px;display: inline-flex;flex-shrink: 0;line-height: 26px;">
                            <a class="item rm-link-color" href="javascript:;" title="Vote Up">
                                <i class="icon thumbs up outline"></i> <span class="count vote-count">{{ $details->praise }}</span> 人点赞
                            </a>
                        </div>
