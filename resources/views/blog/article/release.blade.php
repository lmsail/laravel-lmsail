        ...
        <div class="ui segment">
            ...
            <div class="content extra-padding">
                ...
                @if($errors->has('cate_id'))
                    <div class="ui red message">{{$errors->first('cate_id')}}</div>
                @endif
                ...
                <form method="POST" action="{{ url('release') }}" id="blogform" class="ui form" style="min-height: 49px;">
                        ...
                        <div class="fields">
                            <div class="three wide field">
                                <select class="ui dropdown fluid" name="cate_id" required="">
                                    ...
                                    <option value="{{ $val->id }}">{{ $val->name }}（{{ $val->post_count }}）</option>
                                    @endforeach
                                </select>
                            </div>
                    ...
                    <div class="ui segment" style="padding: 1em;">
                        <div class="inline fields mb-0" id="checkbox">
                            ...
                            <div class="field">
                                <div class="ui radio checkbox">
                                    <input type="radio" name="community_id" tabindex="0" class="hidden" value="{{ $val->id }}">
                                    <label class="ui popover" data-html="{{ $val->name }}">
                                        <img class="ui image display-inline-block" style="width:18px;height:18px;margin-top:-2px;border-radius: 2px;" src="{{ '/uploads/' . $val->logo }}">
                                        {{ str_limit($val->name, 10) }}
                                    </label>
                                </div>
                            </div>
                            @endforeach
