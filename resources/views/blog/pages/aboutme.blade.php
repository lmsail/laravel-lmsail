        ...
        <div class="four wide column">
            <div class="ui card">
                <a class="image" href="#link">
                    <img src="/uploads/{{ config('author.avatar') }}">
                </a>
                <div class="content">
                    <a class="header" href="#link">{{ config('author.author') }} <i class="icon mars"></i></a>
                    <div class="meta" style="color: #636b6f">
                        <div class="my-2">
                            <i class="icon suitcase" style="color:#a5a5a5"></i>  站长 {{ config('author.contact_email') }}
                        </div>

                        <div class="my-2">
                            <i class="icon marker" style="color:#a5a5a5"></i> {{ config('author.city') }}
                        </div>

                        <div class="my-2">
                            <a href="{{ config('author.website') }}" rel="nofollow" target="_blank" class="url">
                                <i class="icon linkify" style="color:#a5a5a5"></i> {{ config('author.website') }}
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="social rm-link-color mt-2 my-3 p-3" style="background: #fff;box-shadow: 0 1px 3px 0 #e3eaefe0, 0 0 0 1px #e1e7ea;">
                ...
                <a href="{{ config('author.github') }}" target="_blank">
                    <i style="color:#a5a5a5;font-size:1.2em" class="icon github alternate"></i>
                </a>
              
                <a href="{{ config('author.weibo') }}" rel="nofollow" class="weibo" target="_blank">
                    <i style="color:#a5a5a5;font-size:1.2em" class="icon weibo"></i>
                </a>
              
                <span class="ui popover" data-html="<img src='/uploads/{{ config('author.weixin') }}' style='width:100%'>">
                    <i style="color:#a5a5a5;font-size:1.2em" class="icon wechat"></i>
                </span>
              
                <a href="{{ config('author.twitter') }}" rel="nofollow" class="twitter" target="_blank">
                    <i style="color:#a5a5a5;font-size:1.2em" class="icon twitter"></i>
                </a>
              
                <a href="{{ config('author.linkedin') }}" rel="nofollow" class="linkedin" target="_blank">
        ...
        <div class="twelve wide column" style="background: #fff">
            ...
            <div class="ui tab active" data-tab="aboutme">
                <div class="p-3" id="aboutme">
                    @if(!empty($content)) {!! $content !!} @else 站长未设置 @endif
                </div>                
            </div>
