...
<footer class="ui inverted vertical footer segment">
    <div class="ui center aligned container" style="color: #c1c1c1;width: 1170px;">
        <p class="pull-left">
            由 <a href="" style="color: #c1c1c1;" target="_blank">{{ config('base.author') }}</a> 设计和编码 <span style="color: #e27575;font-size: 14px;">❤</span>
            - {{ config('base.copyright') }} - {{ config('base.version') }}
        </p>

        <p class="pull-right"><a href="mailto:{{ config('base.contact_email') }}" style="color: #c1c1c1;">有问题请联系我</a></p>
    </div>
</footer>
