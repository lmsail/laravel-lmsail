...
class ApiController extends Controller
{
     ...
     * 我修改了这里
     */
    public function praise(Request $request, Blog $blog, Dynamic $dynamic)
    {
        ...
        if($check) {
            ...
            if($type == 1) {
                ...
                $dynamic->upPraise($foreign_id, 'decrement');
            } else {
                // Blog::where('id', $foreign_id)->decrement('praise');
                $blog->upPraise($foreign_id, 'decrement');
            }
            ...
            if($type == 1) {
                ...
                $dynamic->upPraise($foreign_id, 'increment');
            } else {
                // Blog::where('id', $foreign_id)->increment('praise');
                $blog->upPraise($foreign_id, 'increment');
            }
