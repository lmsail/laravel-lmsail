...
class YamlFileLoaderTest extends TestCase
{
    ...
    public function testImportingRoutesFromDefinition()
    {
        ...
        $this->assertCount(3, $routes);
        $this->assertEquals('/nl', $routes->get('nl')->getPath());
        $this->assertEquals('/en', $routes->get('en')->getPath());
    ...
    public function testImportingWithControllerDefault()
    {
        ...
        $this->assertCount(3, $routes);
        $this->assertEquals('DefaultController::defaultAction', $routes->get('en')->getDefault('_controller'));
        $this->assertEquals('DefaultController::defaultAction', $routes->get('nl')->getDefault('_controller'));
